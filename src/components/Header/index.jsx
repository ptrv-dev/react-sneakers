...
export const Header = ({ total, setIsBasketOpen, favorites }) => {
	const basketOpen = () => setIsBasketOpen(true);
	return (
		<header className={style.header}>
			<Link to="/" className={style.logo}>
				<img
					...
					height={40}
				/>
				<div className={style.logo__col}>
					<h3 className={style.logo__title}>React Sneakers</h3>
					<h4 className={style.logo__subtitle}>Магазин лучших кроссовок</h4>
				</div>
			</Link>
			<ul className={style.actions}>
				<li className={style.actions__item}>
					<button onClick={basketOpen} className={style.actions__link}>
						<svg
							width="20"
							height="20"
							viewBox="0 0 20 20"
				...
				<li className={style.actions__item}>
					<Link to="/favorites" className={style.actions__link}>
						<svg
							width="20"
							height="20"
							viewBox="0 0 22 19"
						...
						{favorites.length < 1 ? "" : <i>{favorites.length}</i>}
					</Link>
				</li>
				<li className={style.actions__item}>
					<Link to="/user" className={style.actions__link}>
						<svg
							width="20"
							height="20"
							viewBox="0 0 20 20"
